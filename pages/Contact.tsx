...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // This constructs an email draft with the user's input and opens their email client
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="bg-secondary/20 p-3 rounded-full text-primary"><MapPin /></div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="bg-secondary/20 p-3 rounded-full text-primary"><Phone /></div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="bg-secondary/20 p-3 rounded-full text-primary"><Mail /></div>
                <div>
            ...
            {/* Map Placeholder */}
            <div className="mt-8 w-full h-64 bg-gray-200 rounded-lg overflow-hidden relative">
              <iframe 
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
            {submitted ? (
              <div className="h-full flex flex-col justify-center items-center text-center">
                ...
                <h3 className="text-2xl font-bold text-primary mb-2">Message Prepared!</h3>
                <p className="text-gray-600">We have opened your email client to send this message to <strong>janakbuilder@gmail.com</strong>.</p>
                <p className="text-sm text-gray-500 mt-2">Please hit 'Send' in your email app to complete the process.</p>
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input required type="text" name="name" value={formData.name} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded focus:ring-2 focus:ring-primary outline-none transition" />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Email Address</label>
                    <input required type="email" name="email" value={formData.email} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded focus:ring-2 focus:ring-primary outline-none transition" />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Subject</label>
                    <input required type="text" name="subject" value={formData.subject} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded focus:ring-2 focus:ring-primary outline-none transition" />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Message</label>
                    <textarea required name="message" rows={4} value={formData.message} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded focus:ring-2 focus:ring-primary outline-none transition"></textarea>
                  </div>
