    ...
    <div className="bg-white">
        ...
        <div className="container mx-auto px-4">
           <div className="bg-white rounded-2xl overflow-hidden shadow-xl flex flex-col md:flex-row">
             <div className="md:w-1/3">
               <img 
                 src="https://drive.google.com/uc?export=view&id=1q7jYgWMFuB17x_S4UGVeJ_SYjIW61TYC" 
                 alt="Er. Mukesh Sah" 
             ...
             <div className="md:w-2/3 p-8 md:p-12 flex flex-col justify-center">
                ...
                <h2 className="text-3xl font-serif font-bold text-primary mb-2">Er. Mukesh Sah</h2>
                <p className="text-gray-500 font-medium mb-6">Founder & Civil Engineer</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center gap-2 text-gray-700"><Check className="text-secondary" size={18}/> <span>B.E. Civil Engineering</span></div>
                  <div className="flex items-center gap-2 text-gray-700"><Check className="text-secondary" size={18}/> <span>5+ Years Experience</span></div>
                  <div className="flex items-center gap-2 text-gray-700"><Check className="text-secondary" size={18}/> <span>Member, Nepal Engineering Council</span></div>
                  <div className="flex items-center gap-2 text-gray-700"><Check className="text-secondary" size={18}/> <span>Structural Analysis Expert</span></div>
                </div>
             </div>
           </div>
        </div>
      ...
      <section className="py-16 container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-6 border border-gray-200 rounded-lg hover:border-secondary transition">
             <h3 className="text-xl font-bold text-primary mb-3">Integrity</h3>
             <p className="text-gray-600">We believe in honest dealings, transparent costs, and keeping our promises to clients.</p>
          </div>
          <div className="p-6 border border-gray-200 rounded-lg hover:border-secondary transition">
             <h3 className="text-xl font-bold text-primary mb-3">Innovation</h3>
             <p className="text-gray-600">Using modern technologies and materials to build efficient and durable structures.</p>
          </div>
          <div className="p-6 border border-gray-200 rounded-lg hover:border-secondary transition">
             <h3 className="text-xl font-bold text-primary mb-3">Sustainability</h3>
             <p className="text-gray-600">Minimizing environmental impact through responsible construction practices.</p>
          </div>
        </div>
      </section>
    </div>
