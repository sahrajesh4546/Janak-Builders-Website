...
import { Menu, X, Phone, Mail, Facebook, Linkedin, LogIn, LayoutDashboard, Sun, Moon, Instagram, PhoneCall } from 'lucide-react';
      ...
      <div className="bg-neutral-900 text-white text-sm py-2 hidden md:block">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <div className="flex gap-4 items-center">
            ...
            <a href={`https://wa.me/${settings.whatsappNumber}`} target="_blank" rel="noreferrer" className="hover:text-secondary" title="WhatsApp"><WhatsAppIcon size={16} /></a>
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              <a href={`https://wa.me/${settings.whatsappNumber}`} target="_blank" rel="noreferrer" className="bg-white/10 p-2 rounded-full hover:bg-secondary hover:text-primary transition" title="WhatsApp"><WhatsAppIcon size={18} /></a>
